...
async def seed():
    async with SessionLocal() as db:
        ...
        services = [
            ...
            Service(category_id=cats["computer-services"].id,
                    name="Computer Support Plan", slug="computer-support-plan",
                    price_type="range", minimum_price=10000, maximum_price=50000,
                    price_unit="month", price_notice="₦10,000–₦50,000/month depending on what you provide (software support, maintenance, printer support, backup, troubleshooting).",
                    short_description="Monthly computer support for small businesses.",
                    description="Monthly computer support package. Software support, computer maintenance, printer support, backup and basic troubleshooting. Price range: ₦10,000–₦50,000/month depending on what you provide."),
            Service(category_id=cats["web-development"].id,
                    name="Website Maintenance Plan", slug="website-maintenance-plan",
                    price_type="range", minimum_price=10000, maximum_price=50000,
                    price_unit="month", price_notice="₦10,000–₦50,000+/month depending on updates, backups, content changes, security checks and minor fixes required.",
                    short_description="Monthly website maintenance and support.",
                    description="Monthly website maintenance package. Updates, backups, content changes, security checks and minor fixes. Price range: ₦10,000–₦50,000+/month."),
            Service(category_id=cats["graphic-design"].id,
                    name="Social Media Management Plan", slug="social-media-management-plan",
                    price_type="range", minimum_price=20000, maximum_price=100000,
                    price_unit="month", price_notice="₦20,000–₦100,000+/month depending on graphics, posts, captions, scheduling and page management scope.",
                    short_description="Monthly social media management.",
                    description="Monthly social media management package. Graphics, posts, captions, scheduling and page management. Price range: ₦20,000–₦100,000+/month."),
            Service(category_id=cats["web-development"].id,
                    name="Basic Website Package", slug="basic-website-package",
                    price_type="quote", base_price=50000, price_unit="project",
                    price_notice="₦50,000+ one-time (optional monthly maintenance). Basic websites start at ₦50,000+.",
                    short_description="Basic business website (from ₦50,000+).",
                    description="Basic website package, one-time development fee from ₦50,000+ with optional maintenance."),
            Service(category_id=cats["web-development"].id,
                    name="Business Website Package", slug="business-website-package",
                    price_type="quote", base_price=100000, price_unit="project",
                    price_notice="₦100,000+ one-time (optional monthly maintenance).",
                    short_description="Business website (from ₦100,000+).",
                    description="Business website package, one-time development fee from ₦100,000+ with optional maintenance."),
            Service(category_id=cats["web-development"].id,
                    name="E-commerce Website Package", slug="ecommerce-website-package",
                    price_type="quote", base_price=150000, price_unit="project",
                    price_notice="₦150,000+ one-time (optional monthly maintenance).",
                    short_description="E-commerce website (from ₦150,000+).",
                    description="E-commerce website package, one-time development fee from ₦150,000+ with optional maintenance."),
        ]
